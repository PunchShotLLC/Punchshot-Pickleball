    ...
    <Box>
      ...
      >
        ...
        <Box display="flex" justifyContent="center" alignItems="center">
          ...
          >
            Select a league to see the league's matches. If you are a team captain, click on a match to edit or submit a score.
          </Typography>
        </Box>
        ...
        >
          ...
          <select 
            ...
            {leagues.length !== 0 ? leagues.map((league, index) => (
              <option id={league['LeagueName']}>{league['LeagueName']}</option>
            )) : null}
          </select>
          ...
          {matches.length > 0 ? <MatchesTable matches={matches} league={league}/> : null }
          </Box>
        </Box>
      </Box>
    </Box>
